...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_app_core_books_resolver_service__ = __webpack_require__("../../../../../src/app/core/books-resolver.service.ts");
    ...
    CoreModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_7_app_core_books_resolver_service__["a" /* BooksResolverService */],
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HTTP_INTERCEPTORS */], useClass: ResponseInterceptor, multi: true },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__logger_service__ = __webpack_require__("../../../../../src/app/core/logger.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_models_bookTrackerError__ = __webpack_require__("../../../../../src/app/models/bookTrackerError.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataService = (function () {
    ...
    DataService.prototype.handleHttpError = function (error) {
        var dataError = new __WEBPACK_IMPORTED_MODULE_6_app_models_bookTrackerError__["a" /* BookTrackerError */]();
    ...
    DataService.prototype.getOldBookById = function (id) {
        return this.http.get("/api/books/" + id)
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["b" /* map */])(function (b) { return ({
            bookTitle: b.title,
            year: b.publicationYear
        }); }), Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["c" /* tap */])(function (classicBook) { return console.log(classicBook); }));
    };
    ...
    DataService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["b" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_5__logger_service__["a" /* LoggerService */]])
    ], DataService);
    return DataService;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_app_core_data_service__ = __webpack_require__("../../../../../src/app/core/data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_bookTrackerError__ = __webpack_require__("../../../../../src/app/models/bookTrackerError.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        if (resolvedData instanceof __WEBPACK_IMPORTED_MODULE_4__models_bookTrackerError__["a" /* BookTrackerError */]) {
        ...
        this.dataService.getAllReaders()
            .subscribe(function (data) { return _this.allReaders = data; }, function (err) { return console.log(err.friendlyMessage); }, function () { return console.log('All done getting readers.'); });
...
var EditBookComponent = (function () {
    ...
    EditBookComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getBookById(bookID)
            .subscribe(function (data) { return _this.selectedBook = data; }, function (err) { return console.log(err); }, function () { return console.log('Complete'); });
...
var EditReaderComponent = (function () {
    ...
    EditReaderComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getReaderById(readerID)
            .subscribe(function (data) { return _this.selectedReader = data; }, function (err) { return console.log(err); }, function () { return console.log('Complete'); });
